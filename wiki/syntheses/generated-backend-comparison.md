...
vehicle and a real-host build. The configured fCCZ4 CI route checks fixed-mesh
Minkowski behavior; general boundaries, remeshing, distributed transport,
and BSSN real-host execution remain separate gates.
...
Claim evidence:
- Claim: the generated Dendro solver has standalone and real-host build branches. The configured real fCCZ4 CI route checks fixed-mesh Minkowski; this does not qualify general boundaries, remeshing, distributed transport, or BSSN real-host execution.
- Role: descriptive behavior
