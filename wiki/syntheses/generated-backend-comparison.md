...
transport and fixed-mesh Minkowski behavior for the default profiles. General
...
Claim evidence:
- Claim: every generated Dendro solver has standalone and real-host build modes; the configured CI route checks both formulations across the standalone order/KO matrix and checks their default profiles for distributed transport and fixed-mesh Minkowski evolution, but not general boundaries or remeshing.
- Role: descriptive behavior
