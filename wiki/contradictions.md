...
The resolution test deliberately requires generated-package import and function
execution because workflow configuration proves generation shape only.
...
Resolved. Both modules now contain one public builder and one
