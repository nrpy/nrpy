...
- Corroboration: [constraints_eval.py](../nrpy/infrastructures/Dendro/general_relativity/BSSN/constraints_eval.py), `CONSTRAINTS_EVAL_GLOBAL_CFUNCTION`; [enforce_detgbar_equals_detghat_trAzero.py](../nrpy/infrastructures/Dendro/general_relativity/enforce_detgbar_equals_detghat_trAzero.py), `ENFORCE_DETGBAR_EQUALS_DETGHAT_TRAZERO_GLOBAL_SUFFIX`
