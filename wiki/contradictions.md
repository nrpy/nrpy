...
- Role: descriptive behavior
- Deciding authority: [BSSN_constraints.py](../nrpy/infrastructures/Dendro/general_relativity/BSSN_constraints.py), the gate save/set/restore around the equation construction
