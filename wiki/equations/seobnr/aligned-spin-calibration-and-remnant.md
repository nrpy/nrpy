...
- [SEOBNRv5HM paper landing page](https://arxiv.org/abs/2303.18039) - background orientation only; Equations 78-81 and calibration mapping are not established
- [HBR2016 paper landing page](https://arxiv.org/abs/1605.01938) - background orientation only; final-spin fit mapping is not established
- [UIB2016 paper landing page](https://arxiv.org/abs/1611.00332) - background orientation only; final-state fit and ancillary mapping are not established
