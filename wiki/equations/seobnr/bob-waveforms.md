...
Class symbols decide implemented outputs. The unversioned SEBOB and BOBv2 paper
landing pages are model background; they do not decide the intended scientific
contract without specific revisions and cited equations. Their model-level accuracy claims are not inherited by these
...
- [SEBOB paper landing page](https://arxiv.org/abs/2508.20418) - background orientation only; attachment/NQC mapping is not established
- [BOBv2 paper landing page](https://arxiv.org/abs/2510.25012) - background orientation only; equation/validation mapping is not established
