...
> Map Backwards-One-Body waveform, NQC attachment, higher-mode, and BOBv2 symbolic quantities. · Status: confirmed
...
Current class symbols decide implemented outputs. The unversioned SEBOB and
BOBv2 paper landing pages are model background; they do not decide the intended
scientific contract without immutable publication locators and cited-equation
mappings. Their model-level accuracy claims are not inherited by these
...
- [SEBOB paper landing page](https://arxiv.org/abs/2508.20418) - background orientation only; attachment/NQC claims have no exact revision mapping here
- [BOBv2 paper landing page](https://arxiv.org/abs/2510.25012) - background orientation only; equation/validation claims have no exact revision mapping here
