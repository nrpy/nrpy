...
> Canonical spellings for recurring code, domain, and experiment entities. · Status: confirmed · Last reconciled: 07-07-2026
...
- [Charm++ language manual](https://github.com/charmplusplus/charm/blob/main/doc/charm%2B%2B/manual.rst) - `Charm++ Interface (.ci) Files`, `Execution Model`, readonly variables, reductions, array maps, structured dagger, PUP.
