...
| `photon_batch_geodesic_integrator_analytical.py` | `python -m nrpy.examples.photon_batch_geodesic_integrator_analytical --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --observer-fov W H --scan-density N --escape-radius R [--cuda] [--outdir DIR]` | Standalone tiled photon raytracing project emitting v6 light-blueprint binary artifacts | Python, C or CUDA toolchain, `make`, NumPy/Matplotlib/Pillow for visualization; Numba optional for acceleration | Manual/source-supported batch route | [Geodesic Raytracing](geodesic-raytracing.md) |
| `photon_batch_geodesic_integrator_numerical.py` | `python -m nrpy.examples.photon_batch_geodesic_integrator_numerical --bin-name FILE --coord-system-numerical SinhCylindricalv2n2 --domain SIZE SINHWRHO SINHWZ RHO_SLOPE Z_SLOPE --t-numerical-end TF --dt-spacetime-data DT --t-start T --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --escape-radius R --eom MODE --interpolation-method METHOD` | CPU/OpenMP tiled photon raytracing project using a combined numerical-spacetime binary and v6 light-blueprint records | Python, C compiler, `make`, and a combined BHaH raytracing dataset | Manual/source-supported numerical batch route | [Geodesic Raytracing](geodesic-raytracing.md) |
| `photon_single_geodesic_integrator_analytical.py` | `python -m nrpy.examples.photon_single_geodesic_integrator_analytical --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --escape-radius R` | Standalone single-photon geodesic project plus trajectory visualization copy | Python, C compiler, `make`, NumPy/Matplotlib for visualization | Manual/source-supported single-ray route | [Geodesic Raytracing](geodesic-raytracing.md) |
| `photon_single_geodesic_integrator_numerical.py` | `python -m nrpy.examples.photon_single_geodesic_integrator_numerical --bin-name FILE --coord-system-numerical SinhCylindricalv2n2 --domain SIZE SINHWRHO SINHWZ RHO_SLOPE Z_SLOPE --t-numerical-end TF --dt-spacetime-data DT --t-start T --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --escape-radius R --eom MODE --interpolation-method METHOD` | CPU/OpenMP single-photon geodesic project using a combined numerical-spacetime binary | Python, C compiler, `make`, and a combined BHaH raytracing dataset | Manual/source-supported numerical single-ray route | [Geodesic Raytracing](geodesic-raytracing.md) |
