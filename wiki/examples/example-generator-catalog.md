...
scratch logs remain generated output. Use the checked-in generator and companion files
...
| Companion group | Checked-in source shape | Generated-file boundary | Owning page |
| --- | --- | --- | --- |
| `nrpy/examples/et_WaveToyfiles/**` | ET ThornList, Carpet WaveToy parfiles, testsuite descriptor, and checked-in ASCII reference data | Generated thorn files under `project/**` remain generated output; checked-in reference data are source evidence | [Einstein Toolkit Thorn Generators](einstein-toolkit-thorn-generators.md) |
| `nrpy/examples/geodesic_visualizations/*.py` | Trajectory plotter, light-blueprint field definitions and reader, lensed-image renderer, image visualizer, and blueprint diagnostics | `trajectory.txt`, PNGs, downloaded textures, and `light_blueprint_*.bin` files remain generated output | [Geodesic Raytracing](geodesic-raytracing.md) |
| `nrpy/examples/tests/sebob*_consistency_check.py` | Current-vs-trusted waveform consistency scripts | Trusted/current generated executable directories and waveform stdout are run output | [Waveform JAX PN Generators](waveform-jax-pn-generators.md) |
