...
> Inventory the runnable example generators, companion scripts, output families, prerequisites, validation status, and owning pages. · Status: confirmed · Last reconciled: 07-30-2026
...
| `photon_batch_geodesic_integrator_analytical.py` | `python -m nrpy.examples.photon_batch_geodesic_integrator_analytical --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --observer-fov W H --scan-density N --escape-radius R [--evolution-measure-max VALUE] [--cuda] [--outdir DIR]` | Standalone tiled photon raytracing project emitting v6 light-blueprint binary artifacts with an upper log-energy cutoff | Python, C or CUDA toolchain, `make`, NumPy/Matplotlib/Pillow for visualization; Numba optional for acceleration | Manual/source-supported batch route | [Geodesic Raytracing](geodesic-raytracing.md) |
| `photon_batch_geodesic_integrator_numerical.py` | `python -m nrpy.examples.photon_batch_geodesic_integrator_numerical --bin-name FILE --coord-system-numerical SinhCylindricalv2n2 --domain SIZE SINHWRHO SINHWZ RHO_SLOPE Z_SLOPE --t-numerical-end TF --dt-spacetime-data DT --t-start T --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --escape-radius R --eom MODE --interpolation-method METHOD [--evolution-measure-max VALUE]` | CPU/OpenMP tiled photon raytracing project using a combined numerical-spacetime binary, common log-energy termination, and v6 light-blueprint records | Python, C compiler, `make`, and a combined BHaH raytracing dataset | Manual/source-supported numerical batch route | [Geodesic Raytracing](geodesic-raytracing.md) |
| `photon_single_geodesic_integrator_analytical.py` | `python -m nrpy.examples.photon_single_geodesic_integrator_analytical --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --escape-radius R [--evolution-measure-max VALUE]` | Standalone single-photon geodesic project with unit observer energy, log-energy cutoff, and trajectory visualization copy | Python, C compiler, `make`, NumPy/Matplotlib for visualization | Manual/source-supported single-ray route | [Geodesic Raytracing](geodesic-raytracing.md) |
| `photon_single_geodesic_integrator_numerical.py` | `python -m nrpy.examples.photon_single_geodesic_integrator_numerical --bin-name FILE --coord-system-numerical SinhCylindricalv2n2 --domain SIZE SINHWRHO SINHWZ RHO_SLOPE Z_SLOPE --t-numerical-end TF --dt-spacetime-data DT --t-start T --observer-position X Y Z --observer-look-forward X Y Z --observer-up UX UY UZ --escape-radius R --eom MODE --interpolation-method METHOD [--evolution-measure-max VALUE]` | CPU/OpenMP single-photon geodesic project using a combined numerical-spacetime binary, selectable EOM, and common log-energy termination | Python, C compiler, `make`, and a combined BHaH raytracing dataset | Manual/source-supported numerical single-ray route | [Geodesic Raytracing](geodesic-raytracing.md) |
...
| `nrpy/examples/geodesic_visualizations/*.py` | Trajectory plotter, light-blueprint schema, lensed-image renderer, image visualizer, and blueprint diagnostics | `trajectory.txt`, PNGs, downloaded textures, and `light_blueprint_*.bin` files stay artifacts | [Geodesic Raytracing](geodesic-raytracing.md) |
...
Inventory disposition is exact for the current aggregate: 29 generators, five
