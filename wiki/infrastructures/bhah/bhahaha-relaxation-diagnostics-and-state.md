...
> Explain the single-horizon relaxation loop, persistent horizon state, BBH common-horizon state, diagnostics, file output, and cleanup paths. · Status: confirmed
> Up: [BHaH](index.md)
