...
Freeze candidate bytes and validation evidence. Any change to either creates a new candidate round and requires fresh validation and two fresh decisions.
