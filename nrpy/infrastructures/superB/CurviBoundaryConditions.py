...
def register_CFunction_bcstruct_chare_set_up(CoordSystem: str) -> None:
  ...
  // STEP 1: SET UP INNER BOUNDARY STRUCTS
  {
    ...
    for (int pt = 0; pt < bcstruct->bc_info.num_inner_boundary_points; pt++) {
      ...
      const int dst_owner = superb_globalidx3_to_owner_idx3(dstpt, Nxx_plus_2NGHOSTS0, Nxx_plus_2NGHOSTS1, Nxx0chare, Nxx1chare, Nxx2chare, Nchare0,
                                                             Nchare1, Nchare2, nghosts);
      const int src_owner = superb_globalidx3_to_owner_idx3(srcpt, Nxx_plus_2NGHOSTS0, Nxx_plus_2NGHOSTS1, Nxx0chare, Nxx1chare, Nxx2chare, Nchare0,
                                                             Nchare1, Nchare2, nghosts);
      ...
      if (dst_owner == idx3_this_chare) {
        ...
        if (src_owner == idx3_this_chare) {
          bcstruct_chare->inner_bc_array[which_inner_chare].dstpt =
              superb_globalidx3_to_owner_localidx3(dstpt, Nxx_plus_2NGHOSTS0, Nxx_plus_2NGHOSTS1, Nxx0chare, Nxx1chare, Nxx2chare,
                                                   Nxx_plus_2NGHOSTS0chare, Nxx_plus_2NGHOSTS1chare, Nchare0, Nchare1, Nchare2, nghosts);
          bcstruct_chare->inner_bc_array[which_inner_chare].srcpt =
              superb_globalidx3_to_owner_localidx3(srcpt, Nxx_plus_2NGHOSTS0, Nxx_plus_2NGHOSTS1, Nxx0chare, Nxx1chare, Nxx2chare,
                                                   Nxx_plus_2NGHOSTS0chare, Nxx_plus_2NGHOSTS1chare, Nchare0, Nchare1, Nchare2, nghosts);
          // Also copy parity
          for (int i = 0; i < 10; ++i) {
    ...
    for (int dirn = 0; dirn < 3; dirn++) {
      ...
      if (bcstruct->bc_info.num_pure_outer_boundary_points[which_gz][dirn] > 0) {
        for (int idx2d = 0; idx2d < bcstruct->bc_info.num_pure_outer_boundary_points[which_gz][dirn]; idx2d++) {
          ...
          if (superb_globalidx3_to_owner_idx3(globalidx3, Nxx_plus_2NGHOSTS0, Nxx_plus_2NGHOSTS1, Nxx0chare, Nxx1chare, Nxx2chare, Nchare0, Nchare1,
                                              Nchare2, nghosts) == idx3_this_chare) {
