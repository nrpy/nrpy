...
def output_solver_cmake(
    ...
    lines: List[str] = list(BANNER) + [
        ...
        "  message(FATAL_ERROR",
        '          "Real Dendro-GR host integration is not generated yet: configure with',
        f'           -D{solver_prefix}_STANDALONE_HOST=ON.")',
        "endif()",
        "",
        ...
        "",
        "# Linking the real Dendro-GR libraries would compile the standalone host",
        ...
        ' generated profile is standalone-host only.")',
        "endif()",
        "",
