# nrpy/infrastructures/Dendro/Dendro_parfile.py
"""
...
BANNER = (
    ...
    " nrpy.infrastructures.Dendro.Dendro_parfile\n"
)


def output_Dendro_parfile(
    ...
    >>> text = output_Dendro_parfile("bssn", "vacuum", (3, 3, 3))
    ...
    sample = CodeParameters.output_parfile_sample()
    commented = "\n".join(
