 ...
 */
void fccz4_initial_data_lambdaU_block(const block_geometry_struct &geom, const DendroScalar *const *in_gfs, DendroScalar *const *out_gfs) {
  ...
  for (int i2 = static_cast<int>(padding); i2 < static_cast<int>(nz - padding); i2++) {
    for (int i1 = static_cast<int>(padding); i1 < static_cast<int>(ny - padding); i1++) {
      for (int i0 = static_cast<int>(padding); i0 < static_cast<int>(nx - padding); i0++) {
        ...
        out_lambdaU1[pp] = FDPart3tmp13 * (FDPart3tmp28 * FDPart3tmp31 + FDPart3tmp29 * FDPart3tmp30 + FDPart3tmp9 * hDD_dD000) +
        ...
        out_lambdaU2[pp] = FDPart3tmp13 * (FDPart3tmp11 * hDD_dD000 + FDPart3tmp28 * FDPart3tmp30 + FDPart3tmp29 * FDPart3tmp32) +
...
} // END FUNCTION: fccz4_initial_data_lambdaU_block
