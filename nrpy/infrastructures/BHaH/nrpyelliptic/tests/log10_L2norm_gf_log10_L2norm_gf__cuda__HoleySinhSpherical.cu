 ...
 */
void log10_L2norm_gf__rfm__HoleySinhSpherical(commondata_struct *restrict commondata, params_struct *restrict params, REAL *restrict xx[3],
...
} // END FUNCTION log10_L2norm_gf__rfm__HoleySinhSpherical
