  ...
  for (int i2 = NGHOSTS; i2 < Nxx_plus_2NGHOSTS2 - NGHOSTS; i2++) {
    ...
    for (int i1 = NGHOSTS; i1 < Nxx_plus_2NGHOSTS1 - NGHOSTS; i1++) {
      ...
      for (int i0 = NGHOSTS; i0 < Nxx_plus_2NGHOSTS0 - NGHOSTS; i0++) {
        ...
        const REAL uu_dD2 = invdxx2 * (FDPart1_Rational_1_12 * (uu_i2m2 - uu_i2p2) + FDPart1_Rational_2_3 * (-uu_i2m1 + uu_i2p1));
        const REAL uu_dDD00 =
         ...
         */
        const REAL FDPart3tmp0 = (1.0 / (SINHWRHO));
        const REAL FDPart3tmp13 = (1.0 / (SINHWZ));
        const REAL FDPart3tmp22 = (1.0 / ((SINHWZ) * (SINHWZ)));
        const REAL FDPart3tmp24 = (1.0 / ((SINHWRHO) * (SINHWRHO)));
        const REAL FDPart3tmp5 = (AMPLRHO - rho_slope) / (exp(FDPart3tmp0) - exp(-FDPart3tmp0));
        const REAL FDPart3tmp17 = (AMPLZ - z_slope) / (exp(FDPart3tmp13) - exp(-FDPart3tmp13));
        const REAL FDPart3tmp2 = exp(FDPart3tmp0 * xx0);
        const REAL FDPart3tmp3 = exp(-FDPart3tmp0 * xx0);
        const REAL FDPart3tmp6 = FDPart3tmp5 * ((xx0) * (xx0));
        const REAL FDPart3tmp15 = exp(FDPart3tmp13 * xx2);
        const REAL FDPart3tmp16 = exp(-FDPart3tmp13 * xx2);
        const REAL FDPart3tmp20 = FDPart3tmp17 * ((xx2) * (xx2));
        const REAL FDPart3tmp4 = FDPart3tmp2 - FDPart3tmp3;
        const REAL FDPart3tmp9 = FDPart3tmp0 * FDPart3tmp2 + FDPart3tmp0 * FDPart3tmp3;
        const REAL FDPart3tmp18 = FDPart3tmp17 * (FDPart3tmp15 - FDPart3tmp16);
        const REAL FDPart3tmp19 = FDPart3tmp13 * FDPart3tmp15 + FDPart3tmp13 * FDPart3tmp16;
        const REAL FDPart3tmp7 = FDPart3tmp4 * FDPart3tmp6 + rho_slope * xx0;
        const REAL FDPart3tmp21 = 2 * FDPart3tmp18 * xx2 + FDPart3tmp19 * FDPart3tmp20 + z_slope;
        const REAL FDPart3tmp11 = 2 * FDPart3tmp4 * FDPart3tmp5 * xx0 + FDPart3tmp6 * FDPart3tmp9 + rho_slope;
        const REAL FDPart3tmp23 = 4 * FDPart3tmp4 * FDPart3tmp5;
        const REAL FDPart3tmp12 = (1.0 / ((FDPart3tmp11) * (FDPart3tmp11)));
        dest_gf_address[IDX3(i0, i1, i2)] =
            (1.0 / 8.0) * ADD_times_AUU / pow(psi_background + uu, 7) + FDPart3tmp12 * uu_dDD00 -
            uu_dD0 * (-1.0 / 2.0 * FDPart3tmp12 * (FDPart3tmp23 * xx0 + 2 * FDPart3tmp6 * FDPart3tmp9 + 2 * rho_slope) / FDPart3tmp7 +
                      (1.0 / 2.0) *
                          (FDPart3tmp23 + 8 * FDPart3tmp5 * FDPart3tmp9 * xx0 +
                           2 * FDPart3tmp6 * (FDPart3tmp2 * FDPart3tmp24 - FDPart3tmp24 * FDPart3tmp3)) /
                          ((FDPart3tmp11) * (FDPart3tmp11) * (FDPart3tmp11))) +
            uu_dDD11 / ((FDPart3tmp7) * (FDPart3tmp7)) + uu_dDD22 / ((FDPart3tmp21) * (FDPart3tmp21)) -
            1.0 / 2.0 * uu_dD2 *
                (8 * FDPart3tmp17 * FDPart3tmp19 * xx2 + 4 * FDPart3tmp18 +
                 2 * FDPart3tmp20 * (FDPart3tmp15 * FDPart3tmp22 - FDPart3tmp16 * FDPart3tmp22)) /
                ((FDPart3tmp21) * (FDPart3tmp21) * (FDPart3tmp21));
