"""
Register function for setting up cell-centered radial grid, for interpolation onto external_input grid.

Set up cell-centered radial grid, to set up radial sampling points for external NR code's interpolation onto external_input grid.
