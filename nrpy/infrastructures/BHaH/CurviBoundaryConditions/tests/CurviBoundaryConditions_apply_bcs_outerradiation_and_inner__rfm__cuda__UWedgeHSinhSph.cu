 ...
 *
 */
void apply_bcs_outerradiation_and_inner__rfm__UWedgeHSinhSph(const commondata_struct *restrict commondata, const params_struct *restrict params,
...
} // END FUNCTION apply_bcs_outerradiation_and_inner__rfm__UWedgeHSinhSph
