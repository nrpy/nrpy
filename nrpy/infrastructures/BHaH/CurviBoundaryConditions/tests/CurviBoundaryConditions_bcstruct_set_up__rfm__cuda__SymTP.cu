...
#include "../set_CodeParameters.h"
  ...
  {
    // xx_to_Cart for EigenCoordinate SymTP (orig coord = SymTP):
    DOUBLE xx0 = xx[0][i0];
    DOUBLE xx1 = xx[1][i1];
    DOUBLE xx2 = xx[2][i2];
    /*
  ...
  // Cart_to_xx for EigenCoordinate SymTP (orig coord = SymTP)
  /*
   *  Original SymPy expressions:
  ...
  {
    // xx_to_Cart for Coordinate SymTP):
    DOUBLE xx0 = xx[0][i0];
    DOUBLE xx1 = xx[1][i1];
    DOUBLE xx2 = xx[2][i2];
    /*
     ...
     *  "[zCart_from_xx = sqrt(bScale**2 + xx0**2)*cos(xx1)]"
     */
    const REAL tmp0 = xx0 * sin(xx1);
    xCart_from_xx = tmp0 * cos(xx2);
    yCart_from_xx = tmp0 * sin(xx2);
    zCart_from_xx = sqrt(((bScale) * (bScale)) + ((xx0) * (xx0))) * cos(xx1);
  }
  ...
  {
    // xx_to_Cart_inbounds for Coordinate SymTP):
     ...
     *  "[zCart_from_xx_inbounds = sqrt(bScale**2 + xx0**2)*cos(xx1)]"
     */
    const REAL tmp0 = xx0 * sin(xx1);
    xCart_from_xx_inbounds = tmp0 * cos(xx2);
    yCart_from_xx_inbounds = tmp0 * sin(xx2);
    zCart_from_xx_inbounds = sqrt(((bScale) * (bScale)) + ((xx0) * (xx0))) * cos(xx1);
  }
...
#define EPS_REL 1e-8
  ...
  if (fabs((DOUBLE)(xCart_from_xx - xCart_from_xx_inbounds)) > EPS_REL * norm_factor ||
    ...
    fprintf(stderr,
            "Error in SymTP coordinate system: Inner boundary point does not map to grid interior point: ( %.15e %.15e %.15e ) != ( %.15e %.15e "
...
#define EPS_REL 1e-8
  ...
  DOUBLE REAL_parity_array[10];
  {
    ...
    */
     ...
     *  "[REAL_parity_array[1] = xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 + xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2
     * + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2))]"
     *  "[REAL_parity_array[2] = xx0*xx0_inbounds*sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) +
     * xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 + xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2))]"
     *  "[REAL_parity_array[3] = sin(xx2)*sin(xx2_inbounds) + cos(xx2)*cos(xx2_inbounds)]"
     *  "[REAL_parity_array[4] = (xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)))**2]"
     *  "[REAL_parity_array[5] = (xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 +
     * xx0_inbounds**2)))*(xx0*xx0_inbounds*sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) +
     * xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 + xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)))]"
     *  "[REAL_parity_array[6] = (sin(xx2)*sin(xx2_inbounds) +
     * cos(xx2)*cos(xx2_inbounds))*(xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)))]"
     *  "[REAL_parity_array[7] = (xx0*xx0_inbounds*sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) +
     * xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 + xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)))**2]"
     *  "[REAL_parity_array[8] = (sin(xx2)*sin(xx2_inbounds) +
     * cos(xx2)*cos(xx2_inbounds))*(xx0*xx0_inbounds*sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) +
     * xx0*xx0_inbounds*cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)/(sqrt(bScale**2*sin(xx1)**2 +
     * xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)) + sqrt(bScale**2 + xx0**2)*sqrt(bScale**2 +
     * xx0_inbounds**2)*sin(xx1)*sin(xx1_inbounds)/(sqrt(bScale**2*sin(xx1)**2 + xx0**2)*sqrt(bScale**2*sin(xx1_inbounds)**2 + xx0_inbounds**2)))]"
     ...
     */
    {
      ...
      const REAL tmp4 = sin(xx1_inbounds);
      const REAL tmp7 = sin(xx2) * sin(xx2_inbounds);
      const REAL tmp9 = cos(xx2) * cos(xx2_inbounds);
      const REAL tmp5 = 1 / (sqrt(tmp1 * ((tmp2) * (tmp2)) + ((xx0) * (xx0))) * sqrt(tmp1 * ((tmp4) * (tmp4)) + ((xx0_inbounds) * (xx0_inbounds))));
      const REAL tmp12 = tmp7 + tmp9;
      const REAL tmp6 = tmp5 * xx0 * xx0_inbounds * cos(xx1) * cos(xx1_inbounds);
      const REAL tmp8 = tmp2 * tmp4 * tmp5 * sqrt(tmp1 + ((xx0) * (xx0))) * sqrt(tmp1 + ((xx0_inbounds) * (xx0_inbounds)));
      const REAL tmp10 = tmp6 + tmp7 * tmp8 + tmp8 * tmp9;
      const REAL tmp11 = tmp6 * tmp7 + tmp6 * tmp9 + tmp8;
      REAL_parity_array[0] = 1;
      REAL_parity_array[1] = tmp10;
      REAL_parity_array[2] = tmp11;
      REAL_parity_array[3] = tmp12;
      REAL_parity_array[4] = ((tmp10) * (tmp10));
      REAL_parity_array[5] = tmp10 * tmp11;
      REAL_parity_array[6] = tmp10 * tmp12;
      REAL_parity_array[7] = ((tmp11) * (tmp11));
      REAL_parity_array[8] = tmp11 * tmp12;
      REAL_parity_array[9] = ((tmp12) * (tmp12));
    }
  }
 ...
 */
void bcstruct_set_up__rfm__SymTP(const commondata_struct *restrict commondata, const params_struct *restrict params, REAL *restrict xx[3],
...
} // END FUNCTION bcstruct_set_up__rfm__SymTP
