 ...
 *
 */
void apply_bcs_outerradiation_and_inner__rfm__RingHoleySinhSpherical(const commondata_struct *restrict commondata,
                                                                     const params_struct *restrict params, const bc_struct *restrict bcstruct,
                                                                     REAL *restrict xx[3], const REAL custom_wavespeed[NUM_EVOL_GFS],
...
} // END FUNCTION apply_bcs_outerradiation_and_inner__rfm__RingHoleySinhSpherical
