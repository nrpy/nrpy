 ...
 */
__host__ __device__ void Cart_to_xx_and_nearest_i0i1i2_assume_valid__rfm__SymTP(const params_struct *restrict params, const REAL xCart[3], REAL xx[3],
...
} // END FUNCTION: Cart_to_xx_and_nearest_i0i1i2_assume_valid__rfm__SymTP
