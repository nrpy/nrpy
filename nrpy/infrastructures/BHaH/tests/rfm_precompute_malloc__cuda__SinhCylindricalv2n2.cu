...
void rfm_precompute_malloc__rfm__SinhCylindricalv2n2(const commondata_struct *restrict commondata, const params_struct *restrict params,
  ...
  BHAH_MALLOC_DEVICE__PtrMember(rfmstruct, f3_of_xx2, sizeof(REAL) * params->Nxx_plus_2NGHOSTS2);
  BHAH_MALLOC_DEVICE__PtrMember(rfmstruct, f3_of_xx2__D2, sizeof(REAL) * params->Nxx_plus_2NGHOSTS2);
  BHAH_MALLOC_DEVICE__PtrMember(rfmstruct, f3_of_xx2__DD22, sizeof(REAL) * params->Nxx_plus_2NGHOSTS2);
