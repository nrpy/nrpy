 ...
 */
void rfm_precompute_defines__rfm__Cartesian(const commondata_struct *restrict commondata, const params_struct *restrict params,
...
} // END FUNCTION rfm_precompute_defines__rfm__Cartesian
