...
static void rfm_precompute_malloc__allocate_host(const params_struct *restrict params, rfm_struct *restrict rfmstruct) {
  ...
  rfmstruct->f2_of_xx0 = (REAL *)malloc(sizeof(REAL) * params->Nxx_plus_2NGHOSTS0);
  rfmstruct->f2_of_xx0__D0 = (REAL *)malloc(sizeof(REAL) * params->Nxx_plus_2NGHOSTS0);
  rfmstruct->f2_of_xx0__DD00 = (REAL *)malloc(sizeof(REAL) * params->Nxx_plus_2NGHOSTS0);
  rfmstruct->f4_of_xx1 = (REAL *)malloc(sizeof(REAL) * params->Nxx_plus_2NGHOSTS1);
  rfmstruct->f4_of_xx1__D1 = (REAL *)malloc(sizeof(REAL) * params->Nxx_plus_2NGHOSTS1);
  rfmstruct->f4_of_xx1__DD11 = (REAL *)malloc(sizeof(REAL) * params->Nxx_plus_2NGHOSTS1);
