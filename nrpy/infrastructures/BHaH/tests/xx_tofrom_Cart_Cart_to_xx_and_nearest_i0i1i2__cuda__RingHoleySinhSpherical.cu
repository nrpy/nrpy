 ...
 */
__host__ __device__ void Cart_to_xx_and_nearest_i0i1i2__rfm__RingHoleySinhSpherical(const params_struct *restrict params, const REAL xCart[3],
...
} // END FUNCTION Cart_to_xx_and_nearest_i0i1i2__rfm__RingHoleySinhSpherical
