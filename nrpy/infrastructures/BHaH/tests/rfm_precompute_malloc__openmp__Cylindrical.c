 ...
 */
void rfm_precompute_malloc__rfm__Cylindrical(const commondata_struct *restrict commondata, const params_struct *restrict params,
                                             rfm_struct *restrict rfmstruct) {
  rfm_precompute_malloc__allocate_host(params, rfmstruct);
} // END FUNCTION rfm_precompute_malloc__rfm__Cylindrical
