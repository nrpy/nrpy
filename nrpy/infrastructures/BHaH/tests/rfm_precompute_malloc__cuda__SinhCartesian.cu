 ...
 */
void rfm_precompute_malloc__rfm__SinhCartesian(const commondata_struct *restrict commondata, const params_struct *restrict params,
...
} // END FUNCTION rfm_precompute_malloc__rfm__SinhCartesian
