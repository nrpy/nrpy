 ...
 */
void rfm_precompute_malloc__rfm__SinhSphericalv2n2(const commondata_struct *restrict commondata, const params_struct *restrict params,
...
} // END FUNCTION rfm_precompute_malloc__rfm__SinhSphericalv2n2
