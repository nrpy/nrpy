 ...
 */
void Cart_to_xx_and_nearest_i0i1i2__rfm__Spherical(const params_struct *restrict params, const REAL xCart[3], REAL xx[3], int Cart_to_i0i1i2[3]) {
...
} // END FUNCTION Cart_to_xx_and_nearest_i0i1i2__rfm__Spherical
