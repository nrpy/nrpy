...
def register_CFunctions_params_commondata_struct_set_to_default() -> None:
    ...
    ...
    ValueError: Parameter 'bad_real_array' of type 'REAL[5]': For REAL or int array parameters, commondata must be True, add_to_set_CodeParameters_h must be False, and add_to_parfile must be True.
    ...
    Traceback (most recent call last):
    ...
    ValueError: Parameter 'bad_int_array' of type 'int[3]': For REAL or int array parameters, commondata must be True, add_to_set_CodeParameters_h must be False, and add_to_parfile must be True.
