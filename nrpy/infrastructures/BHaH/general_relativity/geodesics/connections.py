# nrpy/infrastructures/BHaH/general_relativity/geodesics/connections.py
"""
Defines the C function for computing analytic Christoffel symbols.

This module provides the generator for an inline C function that calculates the forty
unique components of the Christoffel symbols for a specified spacetime. It analyzes
SymPy expressions to identify and extract spatial coordinates from a flattened state
vector, adjusting the array size based on whether the target is a massive particle or
...
def connections(
    ...
    """
    # Specific setup based on particle type
    if PARTICLE == "massive":
        array_size = 8
    ...
    for alpha in range(4):
        for mu in range(4):
            for nu in range(mu, 4):
                ...
                # Map 3D tensor components to the 1D thread-local C array
