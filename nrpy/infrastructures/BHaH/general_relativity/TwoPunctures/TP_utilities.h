...
REAL ***d3tensor (long nrl, long nrh, long ncl, long nch, long ndl,
                  long ndh);
void free_ivector (int *v, long nl, long nh);
void free_dvector (REAL *v, long nl, long nh);
void free_imatrix (int **m, long nrl, long nrh, long ncl, long nch);
void free_dmatrix (REAL **m, long nrl, long nrh, long ncl, long nch);
void free_d3tensor (REAL ***t, long nrl, long nrh, long ncl, long nch,
		    long ndl, long ndh);
...
void F_of_v (ID_persist_struct par,
       int nvar, int n1, int n2, int n3, derivs v,
	     REAL *F, derivs u);
void J_times_dv (ID_persist_struct par,int nvar, int n1, int n2, int n3, derivs dv,
		 REAL *Jdv, derivs u);
void JFD_times_dv (ID_persist_struct par, int i, int j, int k, int nvar, int n1,
		   int n2, int n3, derivs dv, derivs u, REAL *values);
void SetMatrix_JFD (ID_persist_struct par, int nvar, int n1, int n2, int n3,
		    derivs u, int *ncols, int **cols, REAL **Matrix);
REAL PunctEvalAtArbitPosition (REAL *v, int ivar, REAL A, REAL B, REAL phi,
...
REAL PunctTaylorExpandAtArbitPosition (ID_persist_struct par,int ivar, int nvar, int n1,
                                         int n2, int n3, derivs v, REAL x,
                                         REAL y, REAL z);
REAL PunctIntPolAtArbitPosition (ID_persist_struct par,int ivar, int nvar, int n1,
				   int n2, int n3, derivs v, REAL x,
				   REAL y, REAL z);
void SpecCoef(int n1, int n2, int n3, int ivar, REAL *v, REAL *cf);
REAL PunctEvalAtArbitPositionFast (REAL *v, int ivar, REAL A, REAL B, REAL phi,
                                 int nvar, int n1, int n2, int n3);
REAL PunctIntPolAtArbitPositionFast (ID_persist_struct par,int ivar, int nvar, int n1,
                                   int n2, int n3, derivs v, REAL x,
                                   REAL y, REAL z);


/* Routines in  "CoordTransf.c"*/
void AB_To_XR (int nvar, REAL A, REAL B, REAL *X,
	       REAL *R, derivs U);
void C_To_c (ID_persist_struct par, int nvar, REAL X, REAL R, REAL *x,
	     REAL *r, derivs U);
void rx3_To_xyz (int nvar, REAL x, REAL r, REAL phi, REAL *y,
		 REAL *z, derivs U);
...
void NonLinEquations (ID_persist_struct par, REAL rho_adm,
          REAL A, REAL B, REAL X, REAL R,
		      REAL x, REAL r, REAL phi,
		      REAL y, REAL z, derivs U, REAL *values);
void LinEquations (ID_persist_struct par, REAL A, REAL B, REAL X, REAL R,
		   REAL x, REAL r, REAL phi,
		   REAL y, REAL z, derivs dU, derivs U, REAL *values);
