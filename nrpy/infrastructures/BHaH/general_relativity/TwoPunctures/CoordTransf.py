...
/*-----------------------------------------------------------*/
void
AB_To_XR (int nvar, REAL A, REAL B, REAL *X, REAL *R,
	  derivs U)
...
/*-----------------------------------------------------------*/
void
C_To_c (ID_persist_struct par, int nvar, REAL X, REAL R, REAL *x, REAL *r,
	derivs U)
...
/*-----------------------------------------------------------*/
void
rx3_To_xyz (int nvar, REAL x, REAL r, REAL phi,
	    REAL *y, REAL *z, derivs U)
/* On Entrance: U.d0[]=U[]; U.d1[] =U[]_x;  U.d2[] =U[]_r;  U.d3[] =U[]_3;  */
/*                          U.d11[]=U[]_xx; U.d12[]=U[]_xr; U.d13[]=U[]_x3; */
/*                          U.d22[]=U[]_rr; U.d23[]=U[]_r3; U.d33[]=U[]_33; */
...
/*                          U.d22[]=U[]_yy; U.d2z[]=U[]_yz; U.dzz[]=U[]_zz; */
{
  ...
  *z = r * sin_phi;
  ...
  for (jvar = 0; jvar < nvar; jvar++)
    {
      REAL U_x = U.d1[jvar], U_r = U.d2[jvar], U_3 = U.d3[jvar],
