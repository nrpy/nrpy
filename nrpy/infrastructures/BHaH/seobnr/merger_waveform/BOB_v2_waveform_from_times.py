"""
Register C function for BOBv2-informed merger waveform.
...
def register_CFunction_BOB_v2_waveform_from_times() -> Union[None, pcg.NRPyEnv_type]:
    """
    Register CFunction for computing the (2,2) mode of BOBv2 given the evaluation times.
