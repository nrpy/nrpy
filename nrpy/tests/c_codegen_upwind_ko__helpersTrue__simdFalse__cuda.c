...
const REAL u_dKOD0 = fd_function_dKOD0_fdorder4(&auxevol_gfs[IDX4(UGF, i0, i1, i2)], invdxx0);
const REAL u_dKOD1 = fd_function_dKOD1_fdorder4(&auxevol_gfs[IDX4(UGF, i0, i1, i2)], Nxx_plus_2NGHOSTS0, invdxx1);
const REAL u_dKOD2 = fd_function_dKOD2_fdorder4(&auxevol_gfs[IDX4(UGF, i0, i1, i2)], Nxx_plus_2NGHOSTS0 *Nxx_plus_2NGHOSTS1, invdxx2);
const REAL w_dKOD2 = fd_function_dKOD2_fdorder4(&auxevol_gfs[IDX4(WGF, i0, i1, i2)], Nxx_plus_2NGHOSTS0 *Nxx_plus_2NGHOSTS1, invdxx2);
