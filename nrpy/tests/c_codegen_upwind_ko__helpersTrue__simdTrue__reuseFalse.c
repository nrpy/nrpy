...
const REAL_SIMD_ARRAY UpwindAlgInputu_ddnD0 = SIMD_fd_function_ddnD0_fdorder4(u, u_i0m1, u_i0m2, u_i0m3, u_i0p1, invdxx0);
const REAL_SIMD_ARRAY UpwindAlgInputu_ddnD1 = SIMD_fd_function_ddnD1_fdorder4(u, u_i1m1, u_i1m2, u_i1m3, u_i1p1, invdxx1);
const REAL_SIMD_ARRAY UpwindAlgInputu_ddnD2 = SIMD_fd_function_ddnD2_fdorder4(u, u_i2m1, u_i2m2, u_i2m3, u_i2p1, invdxx2);
...
const REAL_SIMD_ARRAY u_dKOD0 = SIMD_fd_function_dKOD0_fdorder4(u, u_i0m1, u_i0m2, u_i0m3, u_i0p1, u_i0p2, u_i0p3, invdxx0);
const REAL_SIMD_ARRAY u_dKOD1 = SIMD_fd_function_dKOD1_fdorder4(u, u_i1m1, u_i1m2, u_i1m3, u_i1p1, u_i1p2, u_i1p3, invdxx1);
const REAL_SIMD_ARRAY u_dKOD2 = SIMD_fd_function_dKOD2_fdorder4(u, u_i2m1, u_i2m2, u_i2m3, u_i2p1, u_i2p2, u_i2p3, invdxx2);
const REAL_SIMD_ARRAY w_dKOD2 = SIMD_fd_function_dKOD2_fdorder4(w, w_i2m1, w_i2m2, w_i2m3, w_i2p1, w_i2p2, w_i2p3, invdxx2);
