...
const REAL UpwindAlgInputu_ddnD0 = fd_function_ddnD0_fdorder4(u, u_i0m1, u_i0m2, u_i0m3, u_i0p1, invdxx0);
const REAL UpwindAlgInputu_ddnD1 = fd_function_ddnD1_fdorder4(u, u_i1m1, u_i1m2, u_i1m3, u_i1p1, invdxx1);
const REAL UpwindAlgInputu_ddnD2 = fd_function_ddnD2_fdorder4(u, u_i2m1, u_i2m2, u_i2m3, u_i2p1, invdxx2);
