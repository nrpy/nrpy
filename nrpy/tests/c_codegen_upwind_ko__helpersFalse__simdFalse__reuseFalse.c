...
const REAL UpwindAlgInputu_ddnD0 = invdxx0 * (-FDPart1_Rational_1_12 * u_i0m3 + FDPart1_Rational_1_2 * u_i0m2 + FDPart1_Rational_1_4 * u_i0p1 -
                                              FDPart1_Rational_3_2 * u_i0m1 + FDPart1tmp0);
const REAL UpwindAlgInputu_ddnD1 = invdxx1 * (-FDPart1_Rational_1_12 * u_i1m3 + FDPart1_Rational_1_2 * u_i1m2 + FDPart1_Rational_1_4 * u_i1p1 -
                                              FDPart1_Rational_3_2 * u_i1m1 + FDPart1tmp0);
const REAL UpwindAlgInputu_ddnD2 = invdxx2 * (-FDPart1_Rational_1_12 * u_i2m3 + FDPart1_Rational_1_2 * u_i2m2 + FDPart1_Rational_1_4 * u_i2p1 -
                                              FDPart1_Rational_3_2 * u_i2m1 + FDPart1tmp0);
...
const REAL u_dupD0 = Upwind0 * (-UpwindAlgInputu_ddnD0 + UpwindAlgInputu_dupD0) + UpwindAlgInputu_ddnD0;
const REAL u_dupD1 = Upwind1 * (-UpwindAlgInputu_ddnD1 + UpwindAlgInputu_dupD1) + UpwindAlgInputu_ddnD1;
const REAL u_dupD2 = Upwind2 * (-UpwindAlgInputu_ddnD2 + UpwindAlgInputu_dupD2) + UpwindAlgInputu_ddnD2;
