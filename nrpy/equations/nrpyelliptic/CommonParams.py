...
P0U = [P0_x, P0_y, P0_z]  # define list with linear momenta
...
P1U = [P1_x, P1_y, P1_z]  # define list with linear momenta
...
S0U = [S0_x, S0_y, S0_z]  # define list with angular momenta
...
S1U = [S1_x, S1_y, S1_z]  # define list with angular momenta
