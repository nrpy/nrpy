...
initial_p_r = 2.284343811437988e-03  # quasicircular NRPyPN p_r.
TP_npoints_A = 48
TP_npoints_B = 48
TP_npoints_phi = 20
...
swm2sh_maximum_l_mode_to_compute = 8
if enable_psi4:
...
if enable_BHaHAHA:
    ...
    par.adjust_CodeParam_default("bah_max_iterations", 10000)
