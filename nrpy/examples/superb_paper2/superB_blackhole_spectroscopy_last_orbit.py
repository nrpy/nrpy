...
project_name = "superB_blackhole_spectroscopy_last_orbit"
CoordSystem = "GeneralRFM_fisheyeN1"
set_of_CoordSystems = {CoordSystem}
IDtype = "TP_Interp"
IDCoordSystem = "Cartesian"
num_fisheye_transitions = 1
...
initial_p_r = 0.0  # zero radial momentum; tangential momentum is set below.
TP_npoints_A = 48
TP_npoints_B = 48
TP_npoints_phi = 20
...
swm2sh_maximum_l_mode_to_compute = 2
if enable_psi4:
    list_of_psi4_extraction_radii = [15.0, 20.0, 25.0, 30.0]
    num_psi4_extraction_radii = len(list_of_psi4_extraction_radii)
Nxx_dict = {
    "GeneralRFM_fisheyeN1": [576, 576, 576],
}
default_BH1_mass = default_BH2_mass = 0.5
default_BH1_x_posn = +3.0
default_BH2_x_posn = -3.0
# Fisheye parameters
...
# Use paper-provided TwoPunctures bare masses directly. Positive values
# set give_bare_mass=true, so the target-ADM bare-mass solve is skipped.
par.adjust_CodeParam_default(
    "TP_bare_mass_m",
    0.47656,
)
