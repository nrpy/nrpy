...
import nrpy.infrastructures.BHaH.grhd.tov.tov_initial_data_c_codegen as tov
...
tov.register_CFunction_initial_data(CoordSystem=CoordSystem)
...
shutil.copyfile("tov_id/tov.asc", f"project/{project_name}/tov.asc")
print(f"    TOV initial data file copied to project/{project_name}")
print(
