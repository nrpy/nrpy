 ...
 */
void diagnostics_nearest_2d_yz_plane__rfm__SinhSpherical(commondata_struct *restrict commondata, const params_struct *restrict params,
...
#include "../set_CodeParameters.h"
  ...
  // 1D output
  char filename[256];
  sprintf(filename, "out2d-yz-conv_factor%.2f-t%08.2f.txt", convergence_factor, time);
  ...
  // Output data in yz-plane in SinhSpherical coordinates.
...
#pragma omp parallel for
  ...
  LOOP_NOOMP(i0_pt, 0, numpts_i0, i1_pt, 0, numpts_i1, i2_pt, 0, numpts_i2) {
    ...
    xx_to_Cart(commondata, params, xx, i0, i1, i2, xCart);
    {
      ...
      fprintf(outfile, "%.15e %.15e %.15e %.15e %.15e %.15e %.15e\n", xCart[1], xCart[2], log10HL, log10sqrtM2L, cfL, alphaL, trKL);
    }
  }
