// CoordTransf.c from TwoPunctures. Note that this C file is just a collection of functions for Coordinate transformations. TP_CoordTransf() is
// unused.
...
{
  int jvar;
  REAL sin_phi = sin(phi), cos_phi = cos(phi), sin2_phi = sin_phi * sin_phi, cos2_phi = cos_phi * cos_phi, sin_2phi = 2 * sin_phi * cos_phi,
  ...
  *z = r * sin_phi;
  ...
  for (jvar = 0; jvar < nvar; jvar++) {
    REAL U_x = U.d1[jvar], U_r = U.d2[jvar], U_3 = U.d3[jvar], U_xx = U.d11[jvar], U_xr = U.d12[jvar], U_x3 = U.d13[jvar], U_rr = U.d22[jvar],
         U_r3 = U.d23[jvar], U_33 = U.d33[jvar];
    U.d1[jvar] = U_x;                                                    /* U_x*/
