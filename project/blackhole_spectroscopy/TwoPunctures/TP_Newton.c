// Newton.c from TwoPunctures. Note that this C file is a collection of functions for Newton-Raphson method, with TP_Newton() being housed here.
...
static int bicgstab(ID_persist_struct par, int const nvar, int const n1, int const n2, int const n3, derivs v, derivs dv, int const output,
                    int const itmax, REAL const tol, REAL *restrict const normres);
static REAL norm_inf(REAL const *restrict const F, int const ntotal);
static void relax(REAL *restrict const dv, int const nvar, int const n1, int const n2, int const n3, REAL const *restrict const rhs,
                  int const *restrict const ncols, int **cols, REAL **JFD);
/*
  static void
  ...
  REAL **JFD);
*/
static void LineRelax_al(REAL *restrict const dv, int const j, int const k, int const nvar, int const n1, int const n2, int const n3,
                         REAL const *restrict const rhs, int const *restrict const ncols, int **cols, REAL **JFD);
static void LineRelax_be(REAL *restrict const dv, int const i, int const k, int const nvar, int const n1, int const n2, int const n3,
                         REAL const *restrict const rhs, int const *restrict const ncols, int **cols, REAL **JFD);
/* --------------------------------------------------------------------------*/
static REAL norm_inf(REAL const *restrict const F, int const ntotal) {
  REAL dmax = -1;
 ...
 * Newton.c from TwoPunctures. Note that this C file is a collection of functions for Newton-Raphson method, with TP_Newton() being housed here.
 */
void TP_Newton(ID_persist_struct par, int const nvar, int const n1, int const n2, int const n3, derivs v, REAL const tol, int const itmax) {
  int ntotal = n1 * n2 * n3 * nvar, it; // , ii
  REAL *F, dmax, normres;
  derivs u, dv;
