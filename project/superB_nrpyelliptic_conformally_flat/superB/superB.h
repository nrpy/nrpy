...
#include "../diagnostics/diagnostics_volume_integration_helpers_defines.h"
...
#define SET_NXX_PLUS_2NGHOSTS_VARS_CHARE(whichgrid)                                                                                                        \
  const int Nxx_plus_2NGHOSTS0 = &griddata_chare[whichgrid].params.Nxx_plus_2NGHOSTS0;                                                                      \
  const int Nxx_plus_2NGHOSTS1 = &griddata_chare[whichgrid].params.Nxx_plus_2NGHOSTS1;                                                                      \
  const int Nxx_plus_2NGHOSTS2 = &griddata_chare[whichgrid].params.Nxx_plus_2NGHOSTS2;
...
#define DIAGNOSTICS_VOLUME_EXECUTE_RECIPE_FOR_CHARE_GRID 8
#define DIAGNOSTICS_VOLUME_WRITE 9
...
typedef struct __diagnostic_struct__ {
  ...
  //NEW
  diags_integration_recipe_t *recipes;
