...
/* DEFS: readonly CProxy_Timestepping timesteppingArray;
 */
extern CProxy_Timestepping timesteppingArray;
#ifndef CK_TEMPLATES_ONLY
extern "C" void __xlater_roPup_timesteppingArray(void *_impl_pup_er) {
  PUP::er &_impl_p=*(PUP::er *)_impl_pup_er;
  _impl_p|timesteppingArray;
}
#endif /* CK_TEMPLATES_ONLY */
...
void _registermain(void)
{
  ...
  CkRegisterReadonly("timesteppingArray","CProxy_Timestepping",sizeof(timesteppingArray),(void *) &timesteppingArray,__xlater_roPup_timesteppingArray);

  _registertimestepping();
