 ...
 */
void auxevol_gfs_set_to_constant__rfm__SinhSpherical(commondata_struct *restrict commondata, params_struct *restrict params, REAL *restrict xx[3],
...
} // END FUNCTION auxevol_gfs_set_to_constant__rfm__SinhSpherical
