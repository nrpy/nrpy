 ...
 */
void numerical_grid_params_Nxx_dxx_xx__rfm__SinhSpherical(const commondata_struct *restrict commondata, params_struct *restrict params,
  ...
  snprintf(params->CoordSystemName, 100, "SinhSpherical");
...
} // END FUNCTION numerical_grid_params_Nxx_dxx_xx__rfm__SinhSpherical
