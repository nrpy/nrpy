 ...
 */
void ds_min_single_pt__rfm__SinhSpherical(const params_struct *restrict params, const REAL xx0, const REAL xx1, const REAL xx2,
...
} // END FUNCTION ds_min_single_pt__rfm__SinhSpherical
