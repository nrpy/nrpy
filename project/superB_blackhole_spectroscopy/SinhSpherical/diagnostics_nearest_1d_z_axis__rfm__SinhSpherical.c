 ...
 */
void diagnostics_nearest_1d_z_axis__rfm__SinhSpherical(commondata_struct *restrict commondata, const params_struct *restrict params,
...
#include "../set_CodeParameters.h"
  ...
  // Output along z-axis in SinhSpherical coordinates.
