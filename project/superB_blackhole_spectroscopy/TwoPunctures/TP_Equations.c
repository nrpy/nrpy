// Equations.c from TwoPunctures. Note that this C file is just a collection of functions for basic equations. TP_Equations() is unused.
...
/********           Nonlinear Equations            ***********/
/*-----------------------------------------------------------*/
void NonLinEquations(ID_persist_struct par, REAL rho_adm, REAL A, REAL B, REAL X, REAL R, REAL x, REAL r, REAL phi, REAL y, REAL z, derivs U,
                     REAL *values) {
...
/********               Linear Equations           ***********/
/*-----------------------------------------------------------*/
void LinEquations(ID_persist_struct par, REAL A, REAL B, REAL X, REAL R, REAL x, REAL r, REAL phi, REAL y, REAL z, derivs dU, derivs U,
                  REAL *values) {
