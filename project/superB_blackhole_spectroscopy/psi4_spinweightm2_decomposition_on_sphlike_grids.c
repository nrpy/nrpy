...
/*
 * Decompose psi4 across all l,m modes from l=2 up to and including L_MAX (global variable)
 */
void psi4_spinweightm2_decomposition_on_sphlike_grids(const commondata_struct *restrict commondata, const params_struct *restrict params,
                                                      REAL *restrict diagnostic_output_gfs, const REAL *restrict list_of_R_exts,
                                                      const int num_of_R_exts, const int psi4_spinweightm2_sph_harmonics_max_l,
                                                      REAL *restrict xx[3]) {
...
#pragma omp parallel for
        ...
        for (int i2 = NGHOSTS; i2 < Nxx_plus_2NGHOSTS2 - NGHOSTS; i2++) {
          ...
          for (int i = 0; i <= N0; i++) {
            ...
            sum_psi4r += (diagnostic_output_gfs[IDX4(PSI4_PART0REGF, i + closest_i0 - N0 / 2, i1, i2)] +
                          ...
                          diagnostic_output_gfs[IDX4(PSI4_PART2REGF, i + closest_i0 - N0 / 2, i1, i2)]) *
            ...
            sum_psi4i += (diagnostic_output_gfs[IDX4(PSI4_PART0IMGF, i + closest_i0 - N0 / 2, i1, i2)] +
                          ...
                          diagnostic_output_gfs[IDX4(PSI4_PART2IMGF, i + closest_i0 - N0 / 2, i1, i2)]) *
                         l0i__times__w0i_inv[i];
          }
      ...
      lowlevel_decompose_psi4_into_swm2_modes(Nxx_plus_2NGHOSTS1, Nxx_plus_2NGHOSTS2, dxx1, dxx2, swm2sh_maximum_l_mode_to_compute, time, R_ext,
                                              th_array, sinth_array, ph_array, psi4r_at_R_ext, psi4i_at_R_ext);
    }
  }
