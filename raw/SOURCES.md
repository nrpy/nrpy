...
| `https://github.com/paralab/Dendro-GR` | The Dendro-GR application repository, which fetches Dendrolib as a dependency, read at commit `b3261e2a0d3457781b11d63ac5ab38375ffab93b` from a local checkout that this repository does not track or commit. | frozen | 09-06-2026 | partial | Source for the host-side conventions the generated Dendro solver is read beside: `BSSN_GR/src/bssnCtx.cpp`'s padded-origin arithmetic and block reads, `BSSN_GR/include/bssn_constraints.h`, `BSSN_GR/src/physcon.cpp`, and `BSSN_GR/include/parameters.h`. Only the pieces the Dendro and contradiction pages cite are ingested. |
