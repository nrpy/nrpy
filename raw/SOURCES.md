...
| `https://arxiv.org/abs/1605.01938` | arXiv abstract page for HBR2016 final-spin paper. | frozen | 07-12-2026 | partial | Defining paper for final-spin fit family; local NRPy code decides current implementation behavior. |
| `https://arxiv.org/abs/1611.00332` | arXiv abstract page for UIB2016 final-state paper and ancillary implementation. | frozen | 07-12-2026 | partial | Defining paper for nonprecessing remnant-mass and spin fit family; local NRPy code decides current implementation behavior. |
| `https://arxiv.org/abs/2111.02424` | arXiv abstract page for arXiv:2111.02424. | frozen | 07-12-2026 | partial | NRPyElliptic defining scientific background for hyperbolic relaxation and conformally flat binary-puncture initial data. |
| `https://arxiv.org/abs/2303.18039` | arXiv abstract page for SEOBNRv5HM aligned-spin waveform model. | frozen | 07-12-2026 | partial | Intended aligned-spin model and calibration context; local symbolic code decides current transcription behavior. |
| `https://arxiv.org/abs/2303.18046` | arXiv abstract page for SEOBNRv5PHM precessing waveform model. | frozen | 07-12-2026 | partial | Intended precessing dynamics, rotations, and ringdown context; local symbolic code decides current transcription behavior. |
| `https://arxiv.org/abs/2303.18143` | arXiv abstract page for SEOBNRv5 precessing dynamics groundwork. | frozen | 07-12-2026 | partial | Intended precessing-spin dynamics contract for equations cited by implementation. |
| `https://arxiv.org/abs/2508.20418` | arXiv abstract page for SEBOB aligned-spin attachment model. | frozen | 07-12-2026 | partial | Intended EOB-to-BOB attachment and NQC scientific context; local code decides current implementation behavior. |
| `https://arxiv.org/abs/2510.25012` | arXiv abstract page for BOBv2 waveform model. | frozen | 07-12-2026 | partial | Intended BOBv2 equations and dominant-mode validation scope; local code decides current implementation behavior. |
